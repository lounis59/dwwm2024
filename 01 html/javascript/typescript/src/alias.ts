...
/* 
    Je peux utiliser un type pour definir un autre type:
*/
...
/* 
    Ici j'indique que le type "Name" doit etredu meme type que la proprieter "nom" du type "Fruit"
*/
type Name = Fruit["nom"];
let n:Name = "George"

/* 
    Ici notre type "Full" n'accepte grace a keyof que des string qui valent les nom de proprieter de Person "age" ou "nom"
*/
